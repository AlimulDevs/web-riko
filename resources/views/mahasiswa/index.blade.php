...
<div class="container">
    <h3 class="text-center text-secondary">DATA MAHASISWA
    </h3>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="text-right">
                <a class="btn btn-primary" href="/mahasiswa/create-index">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/mahasiswa/edit-index/{{$dtm->id}}" class="btn btn-sm btn-warning"><i class="fas fa-edit text-white"></i></a>

                                <a href="/mahasiswa/delete/{{$dtm->user->id}}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
