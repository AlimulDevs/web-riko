...
<div class="container">
    <h3 class="text-center text-secondary">DATA DOSEN MATA KULIAH
    </h3>
    ...
    <div class="card">
        <div class="card-header">
            <h1 class="text-center">TABEL DOSEN MATA KULIAH</h1>

            <div class="text-right">
                <a class="btn btn-primary" href="/dosenMataKuliah/create-index">
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="example2">
                    ...
                    <tbody class="text-center">
                        ...
                        $no = 1;
                        @endphp
                        @foreach ($data_dosen_mata_kuliah as $dtp )
                        <tr>
                            <td>{{$no++}}</td>
                            <td>{{$dtp->dosen->user->name}}</td>
                            <td>{{$dtp->mata_kuliah->nama}}</td>
                            <td>{{$dtp->kode}}</td>
                            <td>{{$dtp->semester}}</td>
                            ...
                            <td>
                                ...
                                <a href="/dosenMataKuliah/edit-index/{{$dtp->id}}" class="btn btn-sm btn-warning"><i class="fas fa-edit text-white"></i></a>

                                <a href="/dosenMataKuliah/delete/{{$dtp->id}}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
